...
public class RawtypeKaratsubaConvolutionStrategy
    extends RawtypeMediumConvolutionStrategy
{
    /**
    ...
    public RawtypeKaratsubaConvolutionStrategy(int radix)
    {
        super(radix);
    }
    ...
    private boolean isZero(DataStorage x, long index)
    {
        ...
        rawtype data = i.getRawtype();
        i.next();

        return data == 0;
    }

    private static final long serialVersionUID = ${org.apfloat.internal.RawtypeKaratsubaConvolutionStrategy.serialVersionUID};
}
